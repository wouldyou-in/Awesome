...
struct GetBlockScheduleService
{
    static let blockData = GetBlockScheduleService()
    ...
    func getRecommendInfo(completion : @escaping (NetworkResult<Any>) -> Void)
    {
        ...
        let URL = Constants.blockDateURL
    ...
    private func isValidData(data : Data) -> NetworkResult<Any> {
        ...
        guard let decodedData = try? decoder.decode(BlockDataModel.self, from: data)
        else {return .pathErr}
